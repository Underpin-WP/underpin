 ...
 * Sample test case.
 */
class Exporters extends WP_UnitTestCase {
	use Loader_Tests;

	public static function wpSetUpBeforeClass() {
		if ( empty( (array) underpin()->exporters() ) ) {
			self::markTestSkipped( 'The loader ' . get_class( underpin()->exporters() ) . ' does not have anything registered to it, so it has been skipped.' );
		}
	}
